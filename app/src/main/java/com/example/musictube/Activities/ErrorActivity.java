...
public class ErrorActivity extends AppCompatActivity {
    ...
    public static final String ERROR_EMAIL_ADDRESS = "example@example.com";
    public static final String ERROR_EMAIL_SUBJECT = "Exception in MusicTube " + BuildConfig.VERSION_NAME;
