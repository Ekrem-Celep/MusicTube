package com.example.musictube.Fragments;
...
import com.example.musictube.ActionBarHandler;
import com.example.musictube.Activities.ErrorActivity;
import com.example.musictube.Activities.VideoItemDetailActivity;
import com.example.musictube.ActivityCommunicator;
import com.example.musictube.Download.DownloadDialog;
import com.example.musictube.Download.Downloader;
import com.example.musictube.Extractor.AudioStream;
import com.example.musictube.Extractor.MediaFormat;
import com.example.musictube.Extractor.ParsingException;
import com.example.musictube.Extractor.ServiceList;
import com.example.musictube.Extractor.Services.YouTube.YoutubeStreamExtractor;
import com.example.musictube.Extractor.StreamExtractor;
import com.example.musictube.Extractor.StreamInfo;
import com.example.musictube.Extractor.StreamPreviewInfo;
import com.example.musictube.Extractor.StreamingService;
import com.example.musictube.Extractor.VideoStream;
import com.example.musictube.Localization;
import com.example.musictube.MainActivity;
import com.example.musictube.Player.BackgroundPlayer;
import com.example.musictube.Player.ExoPlayerActivity;
import com.example.musictube.Player.PlayVideoActivity;
...
public class VideoItemDetailFragment extends Fragment {
    ...
    /*
     * Fragmentet argument som representerar objektet ID som detta fragment
     * representerar.
     */
        ...
        public void run() {
            ...
            // ----------------------------------------
                ...
                if(!streamInfo.errors.isEmpty()) {
                    ...
                    ErrorActivity.reportError(h, getActivity(), e, MainActivity.class, null,
                            ErrorActivity.ErrorInfo.make(ErrorActivity.REQUESTED_STREAM,
                                    service.getServiceInfo().name, videoUrl, R.string.could_not_get_stream));
                } else {
                    ErrorActivity.reportError(h, getActivity(), streamInfo.errors, MainActivity.class, null,
                            ErrorActivity.ErrorInfo.make(ErrorActivity.REQUESTED_STREAM,
                                    service.getServiceInfo().name, videoUrl, R.string.could_not_get_stream));
                }
                h.post(new Runnable() {
    ...
    private void updateInfo(final StreamInfo info) {
        try {
            ...
            // Since MusicTube is designed to work even if certain information is not available,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_video_item_detail, container, false);
