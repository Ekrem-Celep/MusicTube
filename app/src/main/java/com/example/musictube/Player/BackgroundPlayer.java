package com.example.musictube.Player;
...
public class BackgroundPlayer extends Service /*implements MediaPlayer.OnPreparedListener*/ {
    ...
    // Kollar om service:en redan körs
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // Gör nästan allt i en seperat tråd
    ...
    private class PlayerThread extends Thread {
        ...
        public void run() {
            ...
            try {
                // skickar Thumbnai från VideoItemDetailFragment
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(action.equals(ACTION_PLAYPAUSE)) {
                    if(mediaPlayer.isPlaying()) {
                        ...
                        //återfå CPU lås efter automatisk släppa den på paus
        ...
        private Notification buildNotification() {
            ...
            */
            ...
            // Gör notification visas på lockscreen
