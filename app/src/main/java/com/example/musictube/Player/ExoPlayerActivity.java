...
import com.example.musictube.Player.Exoplayer.EventLogger;
import com.example.musictube.Player.Exoplayer.ExtractorRendererBuilder;
import com.example.musictube.Player.Exoplayer.HlsRendererBuilder;
import com.example.musictube.Player.Exoplayer.NPExoPlayer;
...
public class ExoPlayerActivity extends Activity {
    ...
    private NPExoPlayer.RendererBuilder getRendererBuilder() {
        String userAgent = Util.getUserAgent(this, "MusicTubeExoPlayer");
        switch (contentType) {
            case Util.TYPE_SS:
                // default
